...
console.log(createMenuItem("Waffles", 6, "Breakfast"));
console.log(createMenuItem("Tacos", 9, "Lunch"));
...
function lunchSpecial(discount){
  if(discount === 'teacher' || discount === 'student'){
    ...
    return console.log("No discount available");
  }
...
console.log(newRating("Nicole", 4, "Great place to hang out after a long day at the office."));
...
*/
 ...
 function getReviewByRating(arr, rating) {
  ...
  for(let i = 0; i < arrays.length; i++){
    if (arrays[i].rating >= Math.floor(number)) {
      ratingsArray.push(arrays[i]);
    } 
  }
